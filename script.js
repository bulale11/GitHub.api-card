fetch("https://api.github.com/users/Bulale11")
      ...
      .then((data) => {
        ...
        data.forEach((element) => {
          if (element["fork"] == false) {
            list_show += `<li><a href="https://github.com/Bulale11/${element["name"]}" target="_blank" style="color:white; text-decoration:none;">${element["name"]}</a></li> <hr>`;
            num++;
          } else {
            list_fork += `<li><a href="https://github.com/Bulale11/${element["name"]}" target="_blank" style="color:white; text-decoration:none;">${element["name"]}</a></li> <hr>`;
          }
        });
